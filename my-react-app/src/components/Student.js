//Student( studentID : int, yearLevel : int, faculty : varchar, membership : boolean, name : varchar, email : varchar, dietaryRestrictions: varchar, eventID : int, ticketID : int, formID : int)
